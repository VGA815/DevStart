...
namespace DevStart.Infrastructure.Database.Migrations
{
    ...
    [Migration("20260818072446_AddTermSheetPdfToDealDocuments")]
    partial class AddTermSheetPdfToDealDocuments
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DevStart.Domain.AccountDeletion.AccountDeletionRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_account_deletion_requests");
                    ...
                    b.ToTable("account_deletion_requests", "public");
                });
            ...
            modelBuilder.Entity("DevStart.Domain.Admin.BannedIdentity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_banned_identities");

                    b.HasIndex("EmailHash")
                        .HasDatabaseName("ix_banned_identities_email_hash");

                    b.ToTable("banned_identities", "public");
                });

            modelBuilder.Entity("DevStart.Domain.ChatFiles.ChatFile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_chat_files");

                    b.HasIndex("MessageId")
                        .HasDatabaseName("ix_chat_files_message_id");

                    b.HasIndex("UploaderId")
                        .HasDatabaseName("ix_chat_files_uploader_id");

                    b.ToTable("chat_files", "public");
                });
            ...
            modelBuilder.Entity("DevStart.Domain.DealDocuments.DealDocument", b =>
                {
                    ...
                    b.Property<string>("TermSheetPdfObjectKey")
                        .IsRequired()
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("term_sheet_pdf_object_key");

                    b.Property<string>("TermSheetPdfSha256")
                        .IsRequired()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
            ...
            modelBuilder.Entity("DevStart.Domain.Messages.Message", b =>
                {
                    ...
                    b.Property<Guid?>("SentByProfileId")
                        .HasColumnType("uuid")
                        .HasColumnName("sent_by_profile_id");
            ...
            modelBuilder.Entity("DevStart.Domain.Notifications.Notification", b =>
                {
                    ...
                    b.HasIndex("Type", "ReferenceId", "CreatedAt")
            ...
            modelBuilder.Entity("DevStart.Domain.Valuation.BenchmarkIndustryMapping", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_benchmark_industry_mapping");

                    b.ToTable("benchmark_industry_mapping", "public");
                });

            modelBuilder.Entity("DevStart.Domain.Valuation.BenchmarkIssuer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<decimal?>("RevenueOverride")
                        .HasColumnType("numeric(20,2)")
                        .HasColumnName("revenue_override");

                    b.Property<int?>("RevenueOverrideFiscalYear")
                        .HasColumnType("integer")
                        .HasColumnName("revenue_override_fiscal_year");

                    b.Property<string>("RevenueOverrideNote")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_benchmark_issuer");

                    b.HasIndex("Ticker")
                        .IsUnique()
                        .HasDatabaseName("ux_benchmark_issuer_ticker");

                    b.HasIndex("Industry", "IsActive")
                        .HasDatabaseName("ix_benchmark_issuer_industry_active");

                    b.ToTable("benchmark_issuer", "public");
                });

            modelBuilder.Entity("DevStart.Domain.Valuation.BenchmarkObservation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("DatasetRegion")
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_benchmark_observation");

                    b.HasIndex("IssuerId")
                        .HasDatabaseName("ix_benchmark_observation_issuer_id");

                    b.HasIndex("Metric", "AsOf")
                        .HasDatabaseName("ix_benchmark_observation_metric_as_of");

                    b.HasIndex("Source", "IssuerId", "ExternalKey", "DatasetRegion", "Metric", "AsOf")
                        .IsUnique()
                        .HasDatabaseName("ux_benchmark_observation_key");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("Source", "IssuerId", "ExternalKey", "DatasetRegion", "Metric", "AsOf"), false);

                    b.ToTable("benchmark_observation", "public");
                });
            ...
            modelBuilder.Entity("DevStart.Domain.Valuation.BenchmarkObservation", b =>
                {
                    b.HasOne("DevStart.Domain.Valuation.BenchmarkIssuer", null)
                        .WithMany()
                        .HasForeignKey("IssuerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_benchmark_observation_benchmark_issuer_issuer_id");
                });
