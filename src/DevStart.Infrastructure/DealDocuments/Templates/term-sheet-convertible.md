...
- **Instrument:** Convertible Loan (regulated by Russian FZ-354/2021)
- **Principal:** ₽{{amount}}
- **Valuation cap:** ₽{{valuation_cap}}
- **Discount:** {{discount_pct}} %
- **Interest rate:** {{interest_rate_pct}} % p.a.
- **Term:** {{term_months}} months
- **Liquidation preference:** {{liquidation_preference}}x
- **Pro-rata rights:** {{pro_rata_rights}}

> If no qualifying priced round closes before the term expires, the investor may demand
> repayment of principal plus accrued interest.
> Notarisation is required for execution.
...
> *Calculated as `(principal + accrued_interest) / valuation_cap`. Actual share at conversion depends
> on the next priced round price relative to the cap.*
