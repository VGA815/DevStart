...
{
    internal sealed class GetConsentDocument : IEndpoint
    {
        public void MapEndpoint(IEndpointRouteBuilder app)
        {
            app.MapGet("api/consent-documents/{type:int}", async (
                int type,
                ...
                CancellationToken cancellationToken) =>
            {
                ...
                var query = new GetConsentDocumentQuery((ConsentType)type);
